...
import { Music, Instagram, Twitter, Video, Globe, Headphones, Radio, Disc3 } from "lucide-react"
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <footer className="px-6 md:px-12 lg:px-24 py-12 border-t border-gray-800">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center">
          <div>
            <p className="text-sm font-bold mb-2">MULTISENSORY ARTIST</p>
            <p className="text-sm font-bold text-gray-400">AI Music • Onchain Music • Graphic Design • UX Design</p>
          </div>
